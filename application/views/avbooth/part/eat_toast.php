...
<table class="table table-boredered">
    ...
    <tr>
        <td>BOOTH PUTIH</td>
        <td>1</td>
        <input type="checkbox" name="eattoa_booth_putih" id="eattoa_booth_putih">
    </tr>
    <tr>
        <td>STICKER</td>
        <td>1</td>
        <input type="checkbox" name="eattoa_sticker" id="eattoa_sticker">
    </tr>
    <tr>
        <td>NEON BOX</td>
    ...
    <tr>
        <td>PAN SANDWICH</td>
        <td>1</td>
        <input type="checkbox" name="eattoa_pan" id="eattoa_pan">
    </tr>
    <tr>
        <td>KOMPOR GAS</td>
        <td>1</td>
        <input type="checkbox" name="eattoa_kom_gas" id="eattoa_kom_gas">
    </tr>
    <tr>
